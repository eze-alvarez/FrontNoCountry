...
const Contacto = () => {
  return (
    <>
      <div className="h-auto flex py-14 px-6 sm:px-8 md:px-20 lg:px-9  items-center justify-center md:items-start md:landscape:h-auto md:h-[calc(100vh-159px)] lg:landscape:h-[calc(100vh-159px)]">
