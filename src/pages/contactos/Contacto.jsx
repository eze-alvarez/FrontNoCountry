...
const Contacto = () => {
  return (
    <>
      <div className="h-auto flex py-14 px-6 sm:px-8 md:px-20 lg:px-9  items-center justify-center  md:landscape:h-auto md:h-[calc(100vh-159px)] lg:landscape:h-[calc(100vh-159px)]">
        <div className="pt-6 flex flex-col  gap-10 md:landscape:flex-row items-center  lg:pt-20">
          <div className="w-full md:w-1/2 ">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl text-center md:text-left text-blue-title leading-tight font-bold tracking-wider">Contactanos</h2>

            <p className="mt-6 text-base lg:text-xl text-center md:text-left text-blue-text font-light tracking-wide leading-relaxed ">
