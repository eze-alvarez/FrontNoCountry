...
const CardHowTo = ({IMG,H1,P}) => {
    return (
        <div  className=" m-auto  max-w-340 h-407 flex flex-col items-center relative">
            <div
                className="circle"
                className=" bg-fondo-card rounded-full w-48 h-48 relative bottom-50 z-10 flex items-center justify-center"
            >
            ...
            <div
                ...
                className=" bg-main-white rounded-2xl m-auto flex flex-col justify-end  h-327 absolute bottom-0  pb-16 text-center"
            >
